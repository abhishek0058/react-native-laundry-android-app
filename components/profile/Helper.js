...
export default class Helper extends Component {
    ...
    async componentWillMount() {
        ...
        this.setState({ userid, label, value, icon, contentType, startingValue: value, keyboard })
    }
    ...
    toggalView = () => {
        ...
        <Input
            ...
            onChangeText = {value => {
                this.setState({ value }); 
                if(this.state.startingValue == value)
    ...
    toggalIcon = () => {
        if(this.state.loading) {
            ...
            return (<Icon active name="done-all" style={{ color: "#008000" }} onPress={() => alert('Please Change the value')} />)
        } else if(this.state.edit) {
            return (<Icon active name="checkmark" style={{ color: "#008000" }} onPress={() => this.changeProfileField()} />)
        } else {
            return (<Icon active name="create" onPress={() => alert('Please Change the value')} />)
        }
    }
